...
<main class="site-content">
  ...
  <section class="about-parallax" aria-label="À propos">
  ...
  <!-- ========== ENGAGEMENTS ========== -->
  <section class="engagements py-5" id="engagements" aria-label="Nos engagements">
    <div class="container">
  ...
  <!-- ========== CONTACT SECTION ========== -->
  <section id="contact" class="contact-section" aria-label="Formulaire de contact">
